...
# -----------------------------------------------------------------------------
_C.DATASET = CN()
_C.DATASET.name = 'AIML_Image_Matting'
_C.DATASET.data_dir = '/Users/xiufeng/Documents/AIML_Project/Code' #定义文件目录
_C.DATASET.train_fg_list = 'train_fg.txt' #定义foreground目录文件，txt里保存每个image foreground的相对路径
_C.DATASET.train_alpha_list = 'train_alpha.txt' #定义alpha目录文件，txt里保存每个image alpha的相对路径
